 ...
 * @class
 * @desc 颜色渐变类class
 * @param {string} startColor - 起始颜色，hex表示方式
 * @param {string} endColor - 结束颜色，hex表示方式
 * @param {number} step - 参数step为渐变步数
 * @return {array} rgb格式下的数组
 */
...
gradientColor.prototype.colorRgb = function (cColor) {
    const reg = /^#([0-9a-fA-f]{3}|[0-9a-fA-f]{6})$/;
    let sColor = cColor.toLowerCase();
